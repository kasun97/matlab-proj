...
% OVERALL MATLAB code for Overall.fig
...
%
%      OVERALL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OVERALL.M with the given input arguments.
%
%      OVERALL('Property','Value',...) creates a new OVERALL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Overall_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Overall_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 12-Mar-2020 11:45:26
...
% varargin   command line arguments to Overall (see VARARGIN)
